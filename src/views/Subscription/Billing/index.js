...
export const Billing = (data) => {
  // The useStripe hook returns a reference to the Stripe instance 
  // passed to the Elements provider.
  const stripe = useStripe();

  // To safely pass the payment information collected by an Element 
  // to the Stripe API, access the component’s underlying 
  // Element instance so that you can use it with other Stripe.js methods.
